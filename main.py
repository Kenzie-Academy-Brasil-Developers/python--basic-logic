...
from mocks import table_2, empty_list, new_product, product_mock, required_keys, table_1
from management import add_product, add_product_extra, calculate_tab, get_product_by_id, get_products_by_type, menu_report
